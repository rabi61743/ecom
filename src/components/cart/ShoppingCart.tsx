...
export default function ShoppingCart() {
  ...
  const handleBulkRemove = () => {
    ...
    setSelectedItems([]);
    success('Items removed', `${selectedItems.length} items removed from cart`);
  };
  ...
  const handleBulkMoveToWishlist = () => {
    ...
    setSelectedItems([]);
    success('Moved to wishlist', `${selectedItems.length} items moved to wishlist`);
  };
  ...
  const applyPromoCode = () => {
    if (promoCode.trim()) {
      ...
      success('Promo applied', `Code "${promoCode}" applied successfully`);
      setPromoCode('');
    }
  };
                            ...
                            <div className="flex gap-1">
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  success('Moved to wishlist', `${item.name} moved to wishlist`);
                                }}
                              >
